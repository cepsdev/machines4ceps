...
objfiles := serialization.o main.o state_machines.o sm_sim_core_asserts.o state_machine_simulation_core.o sm_sim_core_simulation_loop.o state_machine_simulation_core_action_handling.o state_machine_simulation_core_event_handling.o \
  ...
  sm_livelog_storage_utils.o signalgenerator.o gensm.o partitions.o cover_path.o sm_global_functions.o fibex_import.o can_layer_docgen.o asciidoc.o sm_sim_core_shadow_states.o
...
$(TARGET)/sm: $(objfiles)
	...
	$(TARGET)/log4kmw_serialization.o $(TARGET)/log4kmw_dynamic_bitset.o $(TARGET)/log4kmw_record.o $(TARGET)/log4kmw_utils.o $(TARGET)/livelogger.o $(TARGET)/sm_livelog_storage_utils.o $(TARGET)/rdwrn.o $(TARGET)/signalgenerator.o $(TARGET)/gensm.o $(TARGET)/partitions.o $(TARGET)/cover_path.o $(TARGET)/sm_global_functions.o $(TARGET)/fibex_import.o $(TARGET)/can_layer_docgen.o $(TARGET)/asciidoc.o $(TARGET)/sm_sim_core_shadow_states.o -o $(TARGET)/sm
