...
objfiles := serialization.o main.o state_machines.o sm_sim_core_asserts.o state_machine_simulation_core.o sm_sim_core_simulation_loop.o state_machine_simulation_core_action_handling.o state_machine_simulation_core_event_handling.o \
  ...
  ws_api.o virtual_can_api.o streamtransform.o docgen_formats.o docgen_sm.o docgen_macros.o docgen_docwriter_ansi_console.o docgen_docwriter_markdown_jira_style.o docgen_docwriter_factory.o docgen_theme_factory.o  docgen.o docgen_ifelse.o
...
$(TARGET)/ceps: $(objfiles) $(cepslibs)/ceps_interpreter.o
	...
	$(TARGET)/docgen_docwriter_factory.o $(TARGET)/docgen_ifelse.o -o $(TARGET)/ceps -ldl -lpthread -lrt -lcryptopp
