...
systemstates::extbg_betriebsart_in.value();
 ...
 void globfuncs::sm_Antenna_alignment__action__a_antenna_alignment_dont_care(){
  systemstates::ANTENNA_ALIGNMENT_STATUS = 0;
ev_antenna_alignment_status_changed(0);
 }
 void globfuncs::sm_Antenna_alignment__action__a_antenna_is_aligned(){
  systemstates::ANTENNA_ALIGNMENT_STATUS = 1;
  systemstates::ivenet_platform_alignment_state.value = 2;
ev_antenna_alignment_status_changed(1);
 }
 void globfuncs::sm_Antenna_alignment__action__a_antenna_is_not_aligned(){
  systemstates::ANTENNA_ALIGNMENT_STATUS = 2;
  systemstates::ivenet_platform_alignment_state.value = 0;
ev_antenna_alignment_status_changed(2);
 }
...
;
start_timer(((1 * systemstates::TIMER_ACTIVATION.value()) * 1) ,  , );
 }
...
;
 ...
 void globfuncs::sm_Antenna_parkposition_detector__action__a_set_antenna_not_to_be_in_parkpos(){
  systemstates::EVAL_ANTENNA_IS_IN_PARKPOS = 0;
;
 }
...
;
 ...
 void globfuncs::sm_Antenna_to_hinge_down__sm_Antenna_to_parking_position__action__a_antenna_is_in_parking_position(){
  systemstates::ivenet_radar_parkposition_request_state.isRequestActive = 0;
 }
 void globfuncs::sm_Antenna_to_hinge_down__sm_Antenna_to_parking_position__action__a_antenna_is_moving_to_parking_position(){
;
  systemstates::ivenet_radar_parkposition_request_state.isRequestActive = 1;
 }
...
start_timer(((20 * systemstates::TIMER_ACTIVATION.value()) * 1) ,  , );
 }
...
ev_x_drive_move_go(0 , systemstates::x_drive.INDEXPOSITION.value() , 0 , 1);
 }
...
;
;
  systemstates::x_drive.Control.ANTRIEB_MODE_DEFAULT = 0;
 }
...
start_timer(((2 * systemstates::TIMER_ACTIVATION.value()) * 1) ,  , );
 }
...
start_timer(((0.5 * systemstates::TIMER_ACTIVATION.value()) * 1) , );
 }
...
;
  systemstates::ivenet_mast_state.value_out = 1;
 }
...
ev_y_drive_move_go(0 , systemstates::y_drive.INDEXPOSITION.value() , 0 , 1);
 }
...
print(R"(-------- ev_y_drive_move --------
)");
  systemstates::ivenet_mast_state.value_out = 2;
;
 }
...
;
;
  systemstates::y_drive.Control.ANTRIEB_MODE_DEFAULT = 0;
 }
...
;
  systemstates::ivenet_platform_alignment_state.value = 1;
 }
...
ev_level_out_x((systemstates::x_drive.IstPos.value() + systemstates::Talin_state.axis_x.value()));
 }
...
ev_level_out_y((systemstates::y_drive.IstPos.value() + systemstates::Talin_state.axis_y.value()));
 }
...
ev_x_drive_move_go(0 , systemstates::SOLL_POS.value() , 0 , 1);
 }
...
ev_y_drive_move_go(0 , systemstates::y_drive.ARBEITSPOSITION.value() , 0 , 1);
 }
...
start_periodic_timer((systemstates::NODE_HEARTBEAT_PERIOD.value() * 1) ,  , );
 }
 void globfuncs::sm_BAG_heartbeat__action__a_set_payload(){
  systemstates::s_bag_heartbeat_payload = 5;
 }
...
start_timer(((80 * systemstates::TIMER_ACTIVATION.value()) * 1) ,  , );
 }
...
;
start_timer(((5 * systemstates::TIMER_ACTIVATION.value()) * 1) ,  , );
 }
...
start_timer(((4 * systemstates::TIMER_ACTIVATION.value()) * 1) ,  , );
 }
...
;
print(R"(---------- ev_platform_extend_is_finished ---------- 
)");
print(R"(---------- CONTROL ---------- ANTRIEB_MODE:       )" , systemstates::z_drive.Control.ANTRIEB_MODE.value() , R"(
)");
print(R"(---------- CONTROL ---------- ANTRIEB_ENABLE_IN:  )" , systemstates::z_drive.Control.ANTRIEB_ENABLE_IN.value() , R"(
)");
print(R"(---------- CONTROL ---------- BREAK_RELEASE:      )" , systemstates::z_drive.Control.ANTRIEB_BREAK_RELEASE.value() , R"(
)");
print(R"(---------- STATUS  ---------- ANTRIEB_ENABLE_OUT: )" , systemstates::z_drive.Status.ANTRIEB_ENABLE_OUT.value() , R"(
)");
print(R"(---------- STATUS  ---------- ANTRIEB_INPOS:      )" , systemstates::z_drive.Status.ANTRIEB_INPOS.value() , R"(
)");
 }
...
print(R"(---------- ev_platform_extend_is_starting ---------- 
)");
;
 }
...
start_timer(((10 * systemstates::TIMER_ACTIVATION.value()) * 1) ,  , );
 }
...
start_timer(((3 * systemstates::TIMER_ACTIVATION.value()) * 1) ,  , );
 }
...
print(R"(------------------- CURRENT EVENT: )" , argv(0) , R"(
)");
;
 }
...
start_timer(((40 * systemstates::TIMER_ACTIVATION.value()) * 1) ,  , );
 }
...
ev_mast_move(0 , systemstates::z_drive.MAST_INDEXPOSITION.value() , 0 , 1);
 }
...
;
 ...
 void globfuncs::sm_Ctrl__sm_Dispatch__sm_System_extend__thread_2__sm_Platform_extend__sm_Z_drive_to_indexposition__sm_Z_drive_move__action__a_z_drive_movement_start(){
  systemstates::ivenet_platform_alignment_state.value = 4;
;
 }
...
;
;
  systemstates::z_drive.Control.ANTRIEB_MODE_DEFAULT = 0;
 }
...
print(R"(---------- Z_drive_enable ---------- a_enable_z_drive
)");
;
 }
...
print(R"(---------- Z_drive_enable ---------- unexpected timeout
)");
 }
...
ev_z_drive_move_in(0 , systemstates::z_drive.MAST_ZURRPOSITION.value() , 0 , 1);
 }
...
;
 ...
 void globfuncs::sm_Ctrl__sm_Dispatch__sm_Mast_move_up__action__on_enter(){
  systemstates::z_drive.SollPos = 0;
print(R"(sm_Mast_move_up.on_enter --- z_drive.SollGeschw:)" , systemstates::z_drive.SollGeschw.value() , R"(
)");
 }
...
;
 ...
 void globfuncs::sm_Ctrl__sm_Dispatch__sm_Mast_move_down__action__on_enter(){
  systemstates::z_drive.SollPos = 0;
print(R"(sm_Mast_move_down.on_enter --- z_drive.SollGeschw:)" , systemstates::z_drive.SollGeschw.value() , R"(
)");
 }
...
print(R"(---------------------------------------- Z_drive_to_target_position: Preconditions are not met 
)");
;
 }
...
print(R"(SENSOR_SEKOL: )" , systemstates::SENSOR_SEKOL.value() , R"(, SENSOR_SEKOR: )" , systemstates::SENSOR_SEKOR.value() , R"(, SENSOR_SEKGL)" , systemstates::SENSOR_SEKGL.value() , R"(, SENSOR_SEKGR: )" , systemstates::SENSOR_SEKGR.value() , R"(
)");
;
;
;
...
;
 ...
 void globfuncs::sm_ExtBG_operational_state__action__a_extBG_is_online(){
  guards::g_extBG_is_online = guards::guard_impl_1;
  systemstates::extbg_is_online = 1;
;
print(R"(ExtBG is online
)");
 }
...
start_timer(((3 * systemstates::NODE_HEARTBEAT_PERIOD.value()) * 1) ,  , );
 }
 void globfuncs::sm_Flap__action__a_FlapInternalError(){
a_print_sensor_states(R"( unexpected ------------)");
 }
 void globfuncs::sm_Flap__action__a_FlapIsClosed(){
;
a_print_sensor_states(R"()");
 }
...
a_print_sensor_states(R"()");
 ...
 void globfuncs::sm_Flap__action__a_print_sensor_states(){
;
print(R"(----------- SENSOR_HZO: )" , systemstates::SENSOR_HZO.value() , R"(, SENSOR_HZG: )" , systemstates::SENSOR_HZG.value() , R"( ---------------)" ,  , R"(
)");
 }
...
;
  systemstates::HV_COMMUNICATION_INCIDENT = 1;
 }
...
print(R"(HECKVERTEILER: start supervising all components 
)");
;
;
;
...
;
 ...
 void globfuncs::sm_PSM_operational_state__action__a_psm_is_operational(){
  systemstates::PSM_IS_OPERATIONAL = 1;
 }
 void globfuncs::sm_PSM_operational_state__action__a_psm_supervise_traffic(){
start_timer(((10 * systemstates::PSM_TRAFFIC_PERIOD.value()) * 1) ,  , );
 }
...
print(R"([Slide_detector] Taking a snapshot of azimuth, nick and roll
)");
  systemstates::ivenet_own_vehicle_alignment.azimuth_previous = systemstates::ivenet_own_vehicle_alignment.azimuth_current.value();
  systemstates::Talin_state.axis_x_previous = systemstates::Talin_state.axis_x.value();
  systemstates::Talin_state.axis_y_previous = systemstates::Talin_state.axis_y.value();
 }
...
stop_timer();
 ...
 void globfuncs::sm_Slide_detector__action__a_vehicle_is_sliding(){
  systemstates::ivenet_platform_alignment_state.value = 3;
 }
...
;
 ...
 void globfuncs::sm_Stilts_checker__action__a_uncheck(){
  systemstates::STILTS_ARE_CHECKED = 0;
 }
...
;
 ...
 void globfuncs::sm_Talin__action__a_feedback(){
  systemstates::Talin_state.axis_x = 2.7;
  systemstates::Talin_state.axis_y = 3.9;
;
 }
 void globfuncs::sm_Talin__action__a_talin_antenna_is_levelled_out(){
  systemstates::Talin_state.axis_x = 0;
  systemstates::Talin_state.axis_y = 0;
;
 }
...
;
 ...
 void globfuncs::sm_X_drive_operational_state__action__a_x_drive_incident(){
  systemstates::X_DRIVE_COMMUNICATION_INCIDENT = 1;
 }
...
start_timer(((3 * systemstates::DRIVES_HEARTBEAT_PERIOD.value()) * 1) ,  , );
 }
...
print(R"(a_eval_current_y_drive_state   argv ( 1 ): )" , argv(1) , R"(
)");
;
 }
...
stop_timer();
 ...
 void globfuncs::sm_Z_drive_operational_state__action__a_z_drive_incident(){
  systemstates::Z_DRIVE_COMMUNICATION_INCIDENT = 1;
 }
...
stop_timer();
 ...
 void globfuncs::sm_iVeNet_operational_state__action__a_ivenet_incident(){
  systemstates::IVENET_COMMUNICATION_INCIDENT = 1;
 }
...
start_timer(((10 * systemstates::IVENET_TRAFFIC_PERIOD.value()) * 1) ,  , );
 }
