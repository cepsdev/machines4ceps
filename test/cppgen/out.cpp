...
void user_defined_init(){
 ...
 systemstates::io_modul_luftdruck_pneumatiktank_systemdruck_out = truncate((2 * systemstates::Pneumatics.system_pressure.value()));
 systemstates::io_modul_luftdruck_pneumatiktank_systemdruck_in = truncate((2 * systemstates::Pneumatics.system_pressure.value()));
 systemstates::io_modul_luftdruck_pneumatiktank_druck_stuetze_links_out = truncate((2 * systemstates::Pneumatics.stilt_left_pressure.value()));
 systemstates::io_modul_luftdruck_pneumatiktank_druck_stuetze_links_in = truncate((2 * systemstates::Pneumatics.stilt_left_pressure.value()));
 systemstates::io_modul_luftdruck_pneumatiktank_druck_stuetze_rechts_out = truncate((2 * systemstates::Pneumatics.stilt_right_pressure.value()));
 systemstates::io_modul_luftdruck_pneumatiktank_druck_stuetze_rechts_in = truncate((2 * systemstates::Pneumatics.stilt_right_pressure.value()));
...
;
 ...
 systemstates::t_X_drive x_drive;
 systemstates::t_Y_drive y_drive;
 systemstates::t_Z_drive z_drive;
 ...
 systemstates::t_vehicle_data Vehicle;
 systemstates::t_Talin_data Talin_state;
 systemstates::t_heckverteiler_data Heckverteiler_state;
 systemstates::t_Pneumatics Pneumatics;
 ...
 systemstates::t_ivenet_own_vehicle_position ivenet_own_vehicle_position;
 systemstates::t_ivenet_own_vehicle_alignment ivenet_own_vehicle_alignment;
 systemstates::t_ivenet_mast_state ivenet_mast_state;
 systemstates::t_ivenet_platform_alignment_state ivenet_platform_alignment_state;
 systemstates::t_ivenet_radar_enabled_state ivenet_radar_enabled_state;
 systemstates::t_ivenet_radar_parkposition_request_state ivenet_radar_parkposition_request_state;
 systemstates::t_ivenet_radar_position_state ivenet_radar_position_state;
