...
public:
	...
	Rawframe_generator::gen_msg_return_t gen_msg(State_machine_simulation_core*,size_t&,std::map<std::string /*systemstate*/, std::map< int, ceps::ast::Nodebase_ptr> > const & encoding);
