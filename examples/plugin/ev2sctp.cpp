...
namespace mme{
  ...
  uint16_t constexpr CM_ATTEN_PROFILE_IND = 5;
  uint16_t constexpr CM_ATTEN_CHAR_RSP = 6;
  uint16_t constexpr CM_VALIDATE_REQ = 7;
  uint16_t constexpr CM_VALIDATE_CNF = 8;
  uint16_t constexpr CM_SLAC_MATCH_REQ = 9;
  uint16_t constexpr CM_SLAC_MATCH_CNF = 10;
  uint16_t constexpr CM_SET_KEY_REQ = 11;
  uint16_t constexpr CM_SET_KEY_CNF = 12;
  uint16_t constexpr CM_AMP_MAP_REQ = 13;
  uint16_t constexpr CM_AMP_MAP_CNF = 14;
}
...
class Ev2sctp_plugin{
  ...
  bool Ev2sctp_plugin::mme_msg_cm_slac_param_req_setup_symtbl(homeplug_mme_generic* msg, size_t mme_size){
    cm_slac_parm_req_t slac_parm_cnf = msg->mmdata.cm_slac_parm_req;
  ...
  bool Ev2sctp_plugin::mme_msg_cm_slac_parm_cnf_setup_symtbl(homeplug_mme_generic*, size_t mme_size){
    return true;
  }
  bool Ev2sctp_plugin::mme_msg_cm_start_atten_char_ind_setup_symtbl(homeplug_mme_generic*, size_t mme_size){
    return true;
  }
  bool Ev2sctp_plugin::mme_msg_cm_mnbc_sound_ind_setup_symtbl(homeplug_mme_generic*, size_t mme_size){
    return true;
  }
  bool Ev2sctp_plugin::mme_msg_cm_atten_profile_ind_setup_symtbl(homeplug_mme_generic*, size_t mme_size){
    return true;
  }
  bool Ev2sctp_plugin::mme_msg_cm_atten_char_rsp_setup_symtbl(homeplug_mme_generic*, size_t mme_size){
    return true;
  }
  bool Ev2sctp_plugin::mme_msg_cm_validate_req_setup_symtbl(homeplug_mme_generic*, size_t mme_size){
    return true;
  }
  bool Ev2sctp_plugin::mme_msg_cm_validate_cnf_setup_symtbl(homeplug_mme_generic*, size_t mme_size){
    return true;
  }
...
void Ev2sctp_plugin::handle_homeplug_mme(homeplug_mme_generic* msg, size_t mme_size){
  ...
  std::cout << *ceps_fragment << std::endl;
